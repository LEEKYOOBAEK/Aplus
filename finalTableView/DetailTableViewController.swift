...
//    var delegate:MainTableViewController
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let myCell = cell as? MyTableViewCell2 else{
        // Configure the cell...

        return cell
    }
        
        myCell.mainName.text = selectedFile?.name
        myCell.subTitle.text = selectedFile?.subTitle
        self.navigationItem.title = selectedFile?.name
